        ...
        <div class="container-fluid d-flex align-items-center justify-content-center m-0" style="min-height:82vh;"> <!--body-->
            <div class="bg-white border border-2 d-flex justify-content-center" style="min-height: 72vh; width: 75%; border-radius: 20px;">
                ...
                <div class="align-items-center m-1" style="width:80%;">
                    ...
                    <form class="d-grid gap-2" action="action-sign-up-2.php" method="post">

                        <div class="row"> <!--nama-->

                            <label for="nama-peserta" class="col-sm-3 col-form-label">Nama:</label>
                            <div class="col-sm-9"><input type="text" class="form-control" name="nama-peserta" placeholder="Contoh: Tan Ah Beng" data-bs-toggle="tooltip" title="Nama perlu sama dengan nama dalam Kad Pengenalan"></div>
                        ...
                        <div class="row"> <!--no kp-->
                            ...
                            <div class="col-sm-9"><input type="text" class="form-control" name="no-kad-pengenalan" pattern="([0-9]{12})" placeholder="Contoh: 050102070395" data-bs-toggle="tooltip" title="Jangan letak '-'"></div>
                        ...
                        <div class="row"> <!--jantina & umur-->
                            ...
                            <div class="col-sm"><input type="number" class="form-control" name="umur" min="7" max="18" placeholder="Contoh: 17" data-bs-toggle="tooltip" title="Sila masukkan dari 7 hingga 18 sahaja"></div>
                        ...
                        <div class="row"> <!--no telefon-->
                            ...
                            <div class="col-sm-9"><input type="text" class="form-control" name="no-telefon" maxlength="11" placeholder="Contoh: 0123456789" data-bs-toggle="tooltip" title="Jangan letak '-'"></div>
                        ...
                        <div class="row"> <!--kod sekolah-->
                            ...
                            <div class="col-sm-9"><input type="text" class="form-control" name="kod-sekolah" maxlength="7" placeholder="Contoh: PEB1108" data-bs-toggle="tooltip" title="Sila dapat kod sekolah dari pihak sekolah"></div>
                        ...
                        <div class="row"> <!--nama sekolah-->
                            ...
                            <div class="col-sm-9"><input type="text" class="form-control" name="nama-sekolah" placeholder="Contoh: SMJK Phor Tay" data-bs-toggle="tooltip" title="Sila letak nama penuh sekolah"></div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm"><input type="password" class="form-control" name="password" placeholder="Sila masuk katalaluan"></div>

                            <label for="password-confirm" class="col-sm col-form-label">Pengesahan Katalaluan:</label> <!--password-confirm-->

                            <div class="col-sm"><input type="password" class="form-control" name="password-confirm" placeholder="Sila masuk katalaluan"></div>

                        </div>

                        <div class="row gap-2">
                            <button type="button" class="col btn btn-primary text-white ms-2" onclick="document.location='peserta.php'">Kembali</button>
                            <button type="submit" class="col btn btn-primary text-white me-2">Daftar</button>
                        </div>
